...
<div class="content">
<h1> <img src="adi.png" alt="Snow" style="width:15%;"> Log in </h1>
...
<button   onclick="alert('done')" >  Log in </button>

<button   onclick="alert('done ')" > Create New Account </button><br><br>

<input class = "buttons"  type="button" onclick="window.location.href='admin.php'" value="Administrative Log in" />
